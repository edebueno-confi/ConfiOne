...
insert into public.analytics_source_config (domain_key, object_type, hubspot_pipeline_id, label, is_active) values ('commercial','deal','qa-local-commercial','QA Local Comercial',true), ('cs','ticket','qa-local-cs','QA Local Suporte',true) on conflict (domain_key, object_type, hubspot_pipeline_id) do update set is_active=true, label=excluded.label;
