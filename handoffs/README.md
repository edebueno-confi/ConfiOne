...
| 8 | DATA-OPERATION-SCOPE-2026-08-21 | ConfiOne / Analytics | Auditar e fechar o filtro de Operação ponta a ponta | P1 | DONE | APPROVED | CONTROL-PLANE-BACKLOG-2026-08-21 | Owner mission 2026-08-21 | APPROVED no ciclo 2; checkpoint local `4219a0c7baf0b6cdbd4ff59494076acb3212bb3c`; handoff arquivado. |
| 9 | DATA-PIPELINE-STAGE-SCOPE-2026-08-21 | ConfiOne / Analytics | Formalizar compatibilidade Operação → Pipeline → Stage | P1 | ACTIVE | APPROVED | DATA-OPERATION-SCOPE-2026-08-21 | Owner mission 2026-08-21 | Próximo lote elegível; dropdowns e contratos devem impedir combinações incompatíveis sem regra local inventada. |
