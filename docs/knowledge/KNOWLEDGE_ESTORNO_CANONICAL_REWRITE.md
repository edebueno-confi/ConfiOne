# Knowledge Estorno Canonical Rewrite

## Ficha editorial

- títulos legados de origem:
...
- objetivo:
  - apresentar uma visão geral das formas de estorno disponíveis na operação e os cuidados básicos antes de revisar essa configuração
- escopo coberto:
  - visão geral das formas de estorno
  - contexto operacional de escolha
  - cuidados básicos antes de ativar uma forma
...
- a nomenclatura atual da funcionalidade está correta?
- o artigo deve cobrir apenas formas manuais ou também alguma política operacional?
- `Pix` deve ficar fora deste canônico e virar artigo separado?
- `vale-compra` deve ficar fora deste canônico e virar artigo separado?
- existe risco financeiro ou técnico em manter qualquer uma das opções citadas no texto?

### Suporte/CS deve validar
- o texto está claro para cliente B2B?
- o artigo resolve uma dúvida recorrente real?
- o tom está adequado para operação B2B?
- a categoria pública `Estornos e reembolsos` está correta?
- o texto evita criar expectativa indevida de atendimento ou validação automática?

## Decisão de consolidação final pendente

- os dois artigos legados continuam apenas como origem histórica
- o canônico candidato não substitui nenhum conteúdo no produto nesta fase
