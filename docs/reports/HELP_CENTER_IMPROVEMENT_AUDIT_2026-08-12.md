...
> **Status documental:** relatório histórico da primeira varredura. Para o estado atual do banco e a decisão de governança, consulte `docs/reports/PUBLIC_HELP_CENTER_GOVERNANCE_AUDIT_2026-08-12.md`. A auditoria corrente confirmou 69 artigos, 12 categorias, 10 artigos com marcadores de mojibake, 128 referências de asset sem linha correspondente, FAQ sem placeholder e nenhum canal público configurado.
