-- DASHBOARD-HUBSPOT-SERVICE-IDENTITY-V2
-- A migration de catálogo sobrescreveu a identidade interna do RPC.
-- Esta correção é forward-only e mantém o acesso restrito ao caminho protegido.
