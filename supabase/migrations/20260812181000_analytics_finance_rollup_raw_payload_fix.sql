-- Corrige a projeção do código OMIE após o rollup otimizado. O código já foi
-- normalizado em receivable_base; a função não deve reler uma coluna fora da CTE.
...
begin
  ...
  from (
    select
      ...
      max(f.omie_client_id) as omie_client_code,
