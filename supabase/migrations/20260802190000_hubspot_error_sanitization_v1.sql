-- HUBSPOT-ERROR-SANITIZATION-V1
-- O read model nunca deve projetar a mensagem interna bruta do provider.
-- Esta migration e forward-only e nao altera historico armazenado.
