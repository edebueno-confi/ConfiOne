-- DASHBOARD-HUBSPOT-SHARED-WORK-IDENTITY-FIX-V1
-- Corrige a identidade da fila compartilhada sem resetar dados ou reabrir
-- migrações anteriores. O índice existente inclui pipeline_id, portanto cada
-- unidade compartilhada precisa ter uma identidade própria.
...
comment on function public.rpc_analytics_hubspot_start_run(text, text, uuid) is
  'Inicia carga HubSpot incremental/full com unidades compartilhadas separadas por identidade, retomáveis e observáveis.';
