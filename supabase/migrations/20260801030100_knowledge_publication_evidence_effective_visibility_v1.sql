-- Redefine a RPC de evidencia de publicacao para avaliar a visibilidade
-- SUBMETIDA (draft editorial quando existir), em vez da linha canonica do
-- artigo. Complementa 20260801030000; juntas destravam a publicacao publica de
-- artigo ja publicado. Nenhuma regra de governanca foi afrouxada.
...
begin
  ...
  -- A visibilidade avaliada e a SUBMETIDA: para artigo publicado, a alteracao
  -- vive no draft editorial, nao na linha canonica. Validar o artigo aqui
  -- fechava um ciclo sem saida (ver migration 20260801030000).
  if app_private.effective_knowledge_publish_visibility(p_article_id) <> 'public' then
