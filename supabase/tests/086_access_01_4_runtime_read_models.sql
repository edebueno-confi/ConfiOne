...
select ok(has_function_privilege('authenticated', 'public.rpc_admin_list_internal_access_profile_capabilities()', 'execute'), 'authenticated executa apenas o RPC de capabilities');
select ok(has_function_privilege('authenticated', 'public.rpc_admin_list_internal_access_overrides()', 'execute'), 'authenticated executa apenas o RPC de overrides');
